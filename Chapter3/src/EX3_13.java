...
public class EX3_13 {
    public static void main (String[] args){
        ...
        //Compute tax for married jointly or qualifying widower filers
        else if (status == 1) {
            if (income <= 16700)
            tax = income * 0.10;
        ...
        // Compute tax for married separately filers
            ...
            if (income <= 8350)
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104525 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
        }
        ...
        // Compute tax for head of household
                ...
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (117450 - 68525) * 0.28 + (income - 190200) * 0.33;
            else
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (117450 - 68525) * 0.28 + (190200 - 117450) * 0.33 + (income - 372950) * 0.35;
        }
